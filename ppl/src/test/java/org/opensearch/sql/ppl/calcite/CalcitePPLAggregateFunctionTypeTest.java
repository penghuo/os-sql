  ...
  public void testPercentileApproxWithWrongArgType() {
    ...
    verifyQueryThrowsException(
        ...
        "Aggregation function PERCENTILE_APPROX expects field type and additional arguments"
            + " {[INTEGER,INTEGER]|[INTEGER,DOUBLE]|[DOUBLE,INTEGER]|[DOUBLE,DOUBLE]|[INTEGER,INTEGER,INTEGER]|[INTEGER,INTEGER,DOUBLE]|[INTEGER,DOUBLE,INTEGER]|[INTEGER,DOUBLE,DOUBLE]|[DOUBLE,INTEGER,INTEGER]|[DOUBLE,INTEGER,DOUBLE]|[DOUBLE,DOUBLE,INTEGER]|[DOUBLE,DOUBLE,DOUBLE]|[INTEGER,INTEGER,STRING]|[INTEGER,DOUBLE,STRING]|[DOUBLE,INTEGER,STRING]|[DOUBLE,DOUBLE,STRING]|[INTEGER,INTEGER,INTEGER,STRING]|[INTEGER,INTEGER,DOUBLE,STRING]|[INTEGER,DOUBLE,INTEGER,STRING]|[INTEGER,DOUBLE,DOUBLE,STRING]|[DOUBLE,INTEGER,INTEGER,STRING]|[DOUBLE,INTEGER,DOUBLE,STRING]|[DOUBLE,DOUBLE,INTEGER,STRING]|[DOUBLE,DOUBLE,DOUBLE,STRING]},"
