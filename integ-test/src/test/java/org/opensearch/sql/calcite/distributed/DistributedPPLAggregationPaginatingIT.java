...
/**
 * DQE override for CalcitePPLAggregationPaginatingIT. Under DQE, SUM of all-null values returns
 * null (matching standard SQL and the pushdown-disabled path) rather than 0.
 */
