...
final class TransportRpcSerializedValue implements Serializable {
    private static final long serialVersionUID = -4388571068440835689L;

    @Nullable private final byte[] serializedData;

    private TransportRpcSerializedValue(@Nullable byte[] serializedData) {
     ...
     */
    public static TransportRpcSerializedValue valueOf(@Nullable Object value) throws IOException {
        byte[] serializedData = value == null ? null : InstantiationUtil.serializeObject(value);
        return new TransportRpcSerializedValue(serializedData);
    }

    @Override
    public boolean equals(Object o) {
        if (o instanceof TransportRpcSerializedValue) {
            TransportRpcSerializedValue other = (TransportRpcSerializedValue) o;
    ...
    public String toString() {
        return serializedData == null ? "TransportRpcSerializedValue(null)" : "TransportRpcSerializedValue";
    }
}
