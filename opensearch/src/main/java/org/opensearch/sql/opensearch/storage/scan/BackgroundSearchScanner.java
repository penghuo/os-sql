...
public class BackgroundSearchScanner {
  ...
  private final CalciteStateQueryContext.Captured stateQueryContext;
  ...
  public BackgroundSearchScanner(
    ...
    this.stateQueryContext = CalciteStateQueryContext.capture();
          ...
          CompletableFuture.supplyAsync(
              () ->
                  QueryProfiling.withCurrentContext(
                      ctx,
                      () ->
                          CalciteStateQueryContext.withContext(
                              stateQueryContext, () -> client.search(request))),
              backgroundExecutor);
    }
  }
