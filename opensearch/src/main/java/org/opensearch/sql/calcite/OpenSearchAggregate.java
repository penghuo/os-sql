...
public class OpenSearchAggregate extends Aggregate implements OpenSearchRel {
  ...
  /** Creates an OpenSearchAggregate. */
  OpenSearchAggregate(RelOptCluster cluster,
  ...
  @Override public void implement(Implementor implementor) {
    ...
    final ObjectMapper mapper = implementor.openSearchTable.mapper;
    ...
    for (AggregateCall aggCall : aggCalls) {
      ...
      final String name = names.isEmpty() ? OpenSearchConstants.ID : names.get(0);
