...
public final class OkHttpUtil
{
            ...
            boolean useSystemTrustStore)
    {
        ...
        try {
            ...
            clientBuilder.hostnameVerifier(okhttp3.internal.tls.OkHostnameVerifier.INSTANCE);
        }
    ...
    {
        clientBuilder.hostnameVerifier((hostname, session) -> okhttp3.internal.tls.OkHostnameVerifier.INSTANCE.verify(alternativeHostname, session));
    }
