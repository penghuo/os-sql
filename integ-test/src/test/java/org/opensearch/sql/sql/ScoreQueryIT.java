...
public class ScoreQueryIT extends SQLIntegTestCase {
  ...
  /**
   * "query" : { "from": 0, "size": 3, "timeout": "1m", "query": { "bool": { "should": [ { "match":
   * { "address": { "query": "Lane", "operator": "OR", "prefix_length": 0, "max_expansions": 50,
   * "fuzzy_transpositions": true, "lenient": false, "zero_terms_query": "NONE",
   * "auto_generate_synonyms_phrase_query": true, "boost": 100.0 } } }, { "match": { "address": {
   * "query": "Street", "operator": "OR", "prefix_length": 0, "max_expansions": 50,
   * "fuzzy_transpositions": true, "lenient": false, "zero_terms_query": "NONE",
   * "auto_generate_synonyms_phrase_query": true, "boost": 0.5 } } } ], "adjust_pure_negative":
   * true, "boost": 1.0 } }, "_source": { "includes": [ "address" ], "excludes": [] }, "sort": [ {
   * "_score": { "order": "desc" } } ], "track_scores": true }
   *
   * @throws IOException
   */
