...
# Runs timezone conformance test cases (12 cases).
...
for case_file in $(find "${SCRIPT_DIR}/cases/timezone" -name '*.json' | sort); do
    TOTAL=$((TOTAL + 1))
...
echo ""
echo "============================================================"
echo "Timezone Total: ${TOTAL_PASS}/${TOTAL} passed, ${TOTAL_FAIL} failed"
echo "============================================================"
