...
/**
 * Relational expression representing a scan of a table in an OpenSearch data source.
 */
public class OpenSearchToEnumerableConverter extends ConverterImpl implements EnumerableRel {
  OpenSearchToEnumerableConverter(RelOptCluster cluster, RelTraitSet traits,
                                  RelNode input) {
    super(cluster, ConventionTraitDef.INSTANCE, traits, input);
  }

  @Override public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
    return new OpenSearchToEnumerableConverter(getCluster(), traitSet, sole(inputs));
  }
  ...
  @Override public Result implement(EnumerableRelImplementor relImplementor, Prefer prefer) {
    ...
    final OpenSearchRel.Implementor implementor = new OpenSearchRel.Implementor();
    ...
    final Expression fields =
        block.append("fields",
            constantArrayList(
                Pair.zip(OpenSearchRules.OpenSearchFieldNames(rowType),
        ...
        block.append("table",
            requireNonNull(
                implementor.table.getExpression(
                    OpenSearchTable.OpenSearchQueryable.class)));
    ...
    Expression enumerable =
        block.append("enumerable",
            Expressions.call(table,
                OpenSearchMethod.OpenSearch_QUERYABLE_FIND.method, ops,
